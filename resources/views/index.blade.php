...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/m2.jpg" class="d-block w-100" alt="..." height ="500px">
    </div>
    <div class="carousel-item">
      <img src="images/m3.jpg" class="d-block w-100" alt="..." height="500px" >
    </div>
    <div class="carousel-item">
      <img src="images/m1.jpg" class="d-block w-100" alt="..." height="500px">
    </div>
  </div>
...
<br><br>
    <h1><center><b>WALL DECOR</b></center></h1>
<br><br><br>
    ...
    <div class="row">
        <div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            <div class="card" style="width: 38rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title">Decorative Wall Letters</h5>
                    </div>
              </div>
        ...
        <div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            ...
            <div class="card" style="width: 38rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title">Wall Plates & Accents</h5>
                    </div>
              </div>
...
<br><br>
    <h1><center><b>DECOR ITEMS</b></center></h1>
<br><br><br>
<div class="container">
    <div class="row">
        <div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            ...
            <div class="card" style="width: 38rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title">Decorative Objects</h5>
                    </div>
              </div>
        </div>
        <div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            ...
            <div class="card" style="width: 38rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title">Jewellery Organisation
                    </h5>
                    </div>
              </div>
        </div>
...
<br><br>
    <h1><center><b>KITCHEN ITEMS</b></center></h1>
<br><br><br>
    ...
    <div class="row">
        <div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            ...
            <div class="card" style="width: 38rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title">Trays & Platters</h5>
                    </div>
              </div>
        </div>
        <div class="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            ...
            <div class="card" style="width: 38rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title">Dessert & Cake Stands</h5>
                    </div>
              </div>
        </div>
    </div>
